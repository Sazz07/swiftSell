        ...
        <section className='my-24 container mx-auto'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-10'>
                ...
                <div className="shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        <img src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="Product" className="h-80 w-full object-cover rounded-t-xl" />
            ...
            <Link className='w-full flex justify-center mt-10'>
